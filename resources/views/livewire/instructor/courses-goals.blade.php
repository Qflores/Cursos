<section>
    ...
    <h1 class="text-2xl font-bold">META DEL CURSO</h1>
    <hr class="mt-2 mb-6">
            ...
            <div class="card-body bg-gray-100">
                ...
                @else
                    <header class="flex justify-between">
                        ...
                        <div class="">
                            <i wire:click="edit({{ $item }})" class="fas fa-edit text-blue-500 cursor-pointer" type="submit"></i>
                            <i wire:click="destroy({{ $item }})" class="fas fa-trash text-red-500 cursor-pointer ml-2" type="submit"></i>
                        </div>                    
                    </header>
                @endif
            </div>
